...
В гите можно создавать ответвления от основной версии файла для выполнения различных задач, распараллеливания работы. **Текст для конфликта версий**. Эти изменения можно объединять при помощи ранее упомянутой команды git merge.
